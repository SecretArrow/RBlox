...
func _build_ui() -> void:
	...
	# ---- Kiri-atas: nama pemain + health bar (200x18) ----
	var profile := PanelContainer.new()
	profile.name = "ProfilePanel"
	var psb := StyleBoxFlat.new()
	psb.bg_color = Color(0.06, 0.07, 0.11, 0.75)
	...
	osb.bg_color = Color(0.06, 0.07, 0.11, 0.75)
	osb.set_corner_radius_all(10)
	osb.content_margin_left = 14.0
	osb.content_margin_right = 14.0
