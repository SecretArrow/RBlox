...
static func _build_city(w: Dictionary) -> void:
	...
	# Jalan grid (2 sejajar X + 2 sejajar Z)
	_box(blocks, Vector3(-16, 0.05, 0), Vector3(6, 0.1, 100), "#4a4f54", "plastic")
	_box(blocks, Vector3(16, 0.05, 0), Vector3(6, 0.1, 100), "#4a4f54", "plastic")
	_box(blocks, Vector3(0, 0.05, -16), Vector3(100, 0.1, 6), "#4a4f54", "plastic")
	_box(blocks, Vector3(0, 0.05, 16), Vector3(100, 0.1, 6), "#4a4f54", "plastic")
